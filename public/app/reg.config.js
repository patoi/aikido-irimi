...
app.config(['$translateProvider', function($translateProvider) {
  $translateProvider.translations('en', {
    'lang': 'en',
    'bq': 'banquett',
    'reg_step': 'This is how you can register to the Aikido training camp.',
    'reg_step_1': 'Check the prices step by step.',
    'reg_step_2': 'Register.',
    'reg_step_3': 'Let us know what kind of T-shirt you would like to order.',
    'reg_step_4': 'We are going to send you an e-mail uppon the arrival of your registration and your order, in which you would find all the information about the transferring of costs.',
    'reg_step_5': 'Check your registration e-mail, have the money transferd to our account.',
    'events': 'The timetable for different events and exams',
    'thursday': 'Thursday',
    'friday': 'Friday',
    'saturday': 'Saturday',
    'sunday': 'Sunday',
    ...
    'address': 'Address',
    'ab': 'Anniversary Banquett',
    'abText': 'In 2015 we are celebrating our 15th anniversary of the founding of the Renseikan Dojo - Tatabánya. The number of the seats are 80, there is no Banquett ticket but conditions for participation is that you must order a menu. Drinks is not included. You find the menu list in the registration form.',
    'abSuite': 'We ask that you arrive punctually, appropriate clothing.',
    'quartersAccom': 'You can booking quarters in the registration. Quarters is provided in dormitories and there are several beds in the rooms:',
    'transfer': 'Payment',
    ...
    'reg': 'Registration',
    'regDeadLine': 'Online registration deadline: 30.06.2015',
    'organizer': 'ORGANIZER',
    ...
    'label-tel': 'Phone',
    'label-mkdetag': 'I am a MKDE member',
    'label-dojoleader': 'I am a MKDE Dojo leader',
    ...
    'agree': 'Agree',
    'option-label-menu': 'No booking to Banquett',
    'lang-en': 'English',
    'lang-hu': 'Magyar',
    'label-menu': 'Choose a menu, if you want booking to Banquett!',
    ...
    'calcPrice': 'Total',
    'no-banquet': 'You can\'t booking to banquett, because we have exceeded the maximum limit.',
  ...
  $translateProvider.translations('hu', {
    ...
    'reg': 'Regisztráció',
    'regDeadLine': 'Online regisztrációs határidő: 2015.06.30',
    'organizer': 'SZERVEZŐ',
    ...
    'label-dojoleader': 'MKDE Dojo vezető vagyok',
