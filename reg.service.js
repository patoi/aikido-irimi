...
var toHtml = function(reg) {
  ...
  txt += rowRender(MAPS[reg.lang].mTicket, MAPS[reg.lang][reg.ticket] + ' : ' + getPriceOfTicket(reg.dojoleader, reg.mkdeTag, reg.ticket) + ' HUF');
  if (reg.menu) {
